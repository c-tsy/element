<template>
  <div>
    <div class="Ctsy_theme2_block_right_box-body">
      <el-form :model="FormData" ref="FormData" hide-required-asterisk :rules="Rules" size="small">
        ...
        <el-form-item prop="MessageCode">
          <span class="Ctsy_theme2_item_button">
            <el-input v-model="FormData.MessageCode" placeholder="请输入验证码"></el-input>
            <CButton :Time="Time" ButtonText="发送验证码" class="Ctsy_theme2_CButton"></CButton>
          </span>
        </el-form-item>
        <el-form-item class="Ctsy_Form_item" prop="PWD">
          <el-input v-model="FormData.PWD" placeholder="请输入新密码"></el-input>
        </el-form-item>
      </el-form>
    </div>
    <div class="Ctsy_theme2_block_right_box-bottom">
      <button class="Ctsy_theme2_button" @click="Setting('FormData')">设置</button>
    </div>
  </div>
</template>
